    ...
    return (
      <div>
        ...
        <div className="row" id="button">
          <button className="btn btn-primary" onClick={this.addMenu}>
            Add Food
          </button>
        </div>
        <br></br>
            ...
            <tbody>
              {this.state.Menu.map((menu) => (
                <tr key={menu.foodId}>
                  ...
                  <td>
                    <button
                      onClick={() => this.editMenu(menu.foodId)}
                      className="btn btn-outline-primary"
                    >
                      Update
                    </button>
                    <button
                      onClick={() => this.deleteMenu(menu.foodId)}
                    ...
                    <button
                      onClick={() => this.viewMenu(menu.foodId)}
